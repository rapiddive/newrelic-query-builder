...
class QueryBuilder implements SyntaxRendererInterface
{
     ...
     * @return $this
     */
    public function since(MomentAbstract $moment): static
    {
     ...
     * @return $this
     */
    public function until(MomentAbstract $moment): static
    {
     ...
     * @return $this
     */
    public function compareWith(MomentAbstract $moment): static
    {
     ...
     * @return $this
     */
    public function timeSeries(TimePeriod $period = null, $default = 'AUTO'): static
    {
